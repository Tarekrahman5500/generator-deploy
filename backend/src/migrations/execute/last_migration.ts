...
export class M1768233860910CategorySerialNumberAdd1768233864657 implements MigrationInterface {
    name = 'M1768233860910CategorySerialNumberAdd1768233864657'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`category\` ADD \`serial_no\` int NULL`);
