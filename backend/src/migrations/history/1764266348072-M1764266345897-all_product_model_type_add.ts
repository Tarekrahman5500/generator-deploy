...
export class M1764266345897AllProductModelTypeAdd1764266348072 implements MigrationInterface {
    name = 'M1764266345897AllProductModelTypeAdd1764266348072'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`tower_light\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`ups\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`forklift\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`distributor_panels\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`diesel_generator_sets\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`compressors\` ADD \`type\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`automatic_transfer_switch\` ADD \`type\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`automatic_transfer_switch\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`compressors\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`diesel_generator_sets\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`distributor_panels\` DROP COLUMN \`type\``);
