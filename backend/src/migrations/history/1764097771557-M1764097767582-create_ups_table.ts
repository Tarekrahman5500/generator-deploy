...
export class M1764097767582CreateUpsTable1764097771557 implements MigrationInterface {
    name = 'M1764097767582CreateUpsTable1764097771557'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`ups\` (\`id\` varchar(36) NOT NULL, \`model_name\` varchar(255) NOT NULL, \`power_capacity_va\` int NOT NULL, \`power_capacity_watt\` int NOT NULL, \`topology\` enum ('Online', 'Line-interactive') NOT NULL, \`backup_time_min\` int NOT NULL, \`battery_type\` enum ('Lithium-ion', 'VRLA') NOT NULL, \`outlet_count\` int NOT NULL, \`input_voltage_min\` int NOT NULL, \`input_voltage_max\` int NOT NULL, \`output_voltage\` int NOT NULL, \`voltage_unit\` enum ('V', 'mV', 'MV') NOT NULL, \`info_id\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
