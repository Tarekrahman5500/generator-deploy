...
export class M1764099133886CreateContactFormInfoRequestFormTable1764099135905
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`info_request_forms\` (\`id\` varchar(36) NOT NULL, \`full_name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`telephone\` varchar(255) NOT NULL, \`country\` varchar(255) NOT NULL, \`model_number\` varchar(255) NOT NULL, \`created_at\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
