...
export class M1764160472916RemoveTableField1764160475391
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_6e132b5eff0f4fcfb3581b3832\` ON \`category\``,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`category\` ADD \`info_id\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_6e132b5eff0f4fcfb3581b3832\` ON \`category\` (\`info_id\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_6e132b5eff0f4fcfb3581b3832\` ON \`category\` (\`info_id\`)`,
    );
    await queryRunner.query(
