...
export class M1764756398830UpdateAdministratorUsername1764756421756
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`administrators\` CHANGE \`username\` \`user_name\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`administrators\` DROP COLUMN \`user_name\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`administrators\` ADD \`user_name\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`administrators\` CHANGE \`user_name\` \`username\` varchar(255) NOT NULL`,
    );
  }
}
