...
export class M1768410239976FilesLanguageFieldAdd1768410269552 implements MigrationInterface {
    name = 'M1768410239976FilesLanguageFieldAdd1768410269552'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`category\` CHANGE \`serial_no\` \`serial_no\` int NULL`);
