...
export class M1764161281643AddCategoryDescription1764161283727 implements MigrationInterface {
    name = 'M1764161281643AddCategoryDescription1764161283727'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_9228deaf3cc55aa0d37afd344b\` ON \`category_info\``);
        await queryRunner.query(`ALTER TABLE \`category\` ADD \`description\` text NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`category_info\` ADD UNIQUE INDEX \`IDX_9228deaf3cc55aa0d37afd344b\` (\`category_id\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`category_info\` DROP INDEX \`IDX_9228deaf3cc55aa0d37afd344b\``);
        await queryRunner.query(`ALTER TABLE \`category_info\` DROP COLUMN \`category_id\``);
        await queryRunner.query(`ALTER TABLE \`category_info\` ADD \`category_id\` varchar(36) NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_9228deaf3cc55aa0d37afd344b\` ON \`category_info\` (\`category_id\`)`);
        await queryRunner.query(`ALTER TABLE \`category_info\` CHANGE \`updated_at\` \`updated_at\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`category_info\` CHANGE \`created_at\` \`created_at\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
